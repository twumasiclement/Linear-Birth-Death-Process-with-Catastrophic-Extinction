...
plot(state,tau2001[["case1"]],type="l",col="blue",lwd=3,ylab="",xlab="",
    ylim=c(0,.1),axes=FALSE)

lines(state,tau2003[["case1"]],col="red",lwd=2,ylab="",xlab="")

abline(v=41,col="black",lty=3,lwd=3)
...
abline(v=21,col="grey",lty=3,lwd=3)


axis(2, ylim=c(0,0.1),col="black",las=1,xaxt = "n")  ## las=1 makes horizontal labels

mtext(expression(paste("leap size","(",tau,")") ),side=2,line=2.5)
box()


text(240,.1, "Case 1-",col="magenta",lwd=3,font=2)

text(430,.0995, expression(paste("Parameter values:"
                ,lambda,"=0.5",";","", mu,"=0.3",";",rho,"=0.001") ),
    col="magenta",lwd=3,font=2)

text(280,.09, expression(paste("Error bound:"
                ,epsilon,"=0.01") ),col="magenta",lwd=3,font=2)

## Allow a second plot on the same graph
par(new=TRUE)

## Plot the second plot and put axis scale on right
plot(state,leapCondition2003[["case1"]],type="l",col="yellow",lwd=3,ylab="",
    xlab="",axes=FALSE,ylim=c(0,2.5))
lines(state,leapCondition2001[["case1"]],type="l",col="green",lwd=3)
mtext("leap condition",side=4,col="black",line=3) 
...
plot(state,tau2001[["case2"]],type="l",col="blue",lwd=3,ylab="",xlab="",
    ylim=c(0,.1),axes=FALSE)

lines(state,tau2003[["case2"]],col="red",lwd=2,ylab="",xlab="")

abline(v=51,col="black",lty=3,lwd=3)
...
abline(v=31,col="grey",lty=3,lwd=3)
...
text(240,.1, "Case 2-",col="magenta",lwd=3,font=2)
...
text<-c("leap size vs state x (Gillespie 2001)","leap size vs state x (Gillespie & Petzold 2003)",
       "leap condition vs state x (Gillespie 2001)","leap condition vs state x (Gillespie & Petzold 2003)")

legend(x=220,y=.055,legend = text,col=c("blue","red","green","yellow"),bty = "n",
      cex=1.2, horiz = FALSE,pt.cex = 1,fill=c("blue","red","green","yellow"),ncol=1)
...
## Plot the second plot and put axis scale on right
plot(state,leapCondition2003[["case2"]],type="l",col="yellow",lwd=3,ylab="",
    xlab="",axes=FALSE,ylim=c(0,2.5))
lines(state,leapCondition2001[["case2"]],type="l",col="green",lwd=3)
mtext("leap condition",side=4,col="black",line=3) 
axis(4, ylim=c(0,2.5), col="black",col.axis="black",las=1)
...
plot(state,tau2001[["case3"]],type="l",col="blue",lwd=3,ylab="",xlab="",
    ylim=c(0,.1),axes=FALSE)

lines(state,tau2003[["case3"]],col="red",lwd=2,ylab="",xlab="")

abline(v=31,col="black",lty=3,lwd=3)
...
text(240,.1, "Case 3-",col="magenta",lwd=3,font=2)
...
## Plot the second plot and put axis scale on right
plot(state,leapCondition2003[["case3"]],type="l",col="yellow",lwd=3,ylab="",
    xlab="",axes=FALSE,ylim=c(0,2.5))
lines(state,leapCondition2001[["case3"]],type="l",col="green",lwd=3)
mtext("leap condition",side=4,col="black",line=3) 
axis(4, ylim=c(0,2.5), col="black",col.axis="black",las=1)
