...
Time_results1<- data.frame(matrix(NA,nrow=3,ncol=1))
names(Time_results1)<-c("GMM_time") 
rownames(Time_results1)<-c("case1","case2","case3")
#case 1
options(warn=-1)
GMM_results_case1_50<-Simul_data_nruns_GMM_own(X0=2,b=0.5,d=0.3,c=.001,ti=0,tmax=17, nrep=50,nruns=100)

write.csv(GMM_results_case1_50$GMM_estimates,"GMM_results_case1_50.csv")

#Saving accuracy measures
GMM_case1_accuracy_50<-Summary_peformance(MME_data=GMM_results_case1_50$GMM_estimates
                                          ,true_parameter_values=c(0.5,0.3,0.001))
write.csv(GMM_case1_accuracy_50,"GMM_case1_accuracy_50.csv")


#case 2
options(warn=-1)
GMM_results_case2_50<-Simul_data_nruns_GMM_own(X0=2,b=2,d=1,c=0.01,ti=0,tmax=17, nrep=50,nruns=100)

write.csv(GMM_results_case2_50$GMM_estimates,"GMM_results_case2_50.csv")

#Saving accuracy measures
GMM_case2_accuracy_50<-Summary_peformance(MME_data=GMM_results_case2_50$GMM_estimates,
                                          true_parameter_values=c(2,1,0.01))
write.csv(GMM_case2_accuracy_50,"GMM_case2_accuracy_50.csv")


#case 3
options(warn=-1)

GMM_results_case3_50<-Simul_data_nruns_GMM_own(X0=2,b=3,d=2,c=0.1,ti=0,tmax=17, nrep=50,nruns=100)

write.csv(GMM_results_case3_50$GMM_estimates,"GMM_results_case3_50.csv")

#Saving accuracy measures
GMM_case3_accuracy_50<-Summary_peformance(MME_data=GMM_results_case3_50$GMM_estimates,
                                          true_parameter_values=c(3,2,0.1))
write.csv(GMM_case3_accuracy_50,"GMM_case3_accuracy_50.csv")

Time_results1[,1]<- c(GMM_results_case1_50$Computational_time,GMM_results_case2_50$Computational_time,
                      GMM_results_case3_50$Computational_time)
write.csv(Time_results1,"Time_experiment1.csv")
...
write.csv(Time_results2,"Time_experiment2.csv")
...
write.csv(Time_results3,"Time_experiment3.csv")
#Saving accuracy measures
